[![Build Status](https://img.shields.io/travis/j-fu/SimplexGridFactory.jl/master.svg?label=Linux+MacOSX+Windows)](https://travis-ci.com/j-fu/SimplexGridFactory.jl)
